  ...
  with (processingInstance) {
...

    {
      var Button = function (config) {
        ...
        this.borderColorHover =
          config.borderColorHover || color(130, 135, 135, 50)
        this.backColorHover = config.bakColorHover || color(29, 29, 29, 200)
        this.contentColorHover =
          config.contentColorHover || color(222, 222, 222, 200)
      }
...

    {
      ...
      Player.prototype.display = function () {
        ...
        ellipse(
          this.pos.x + this.w / 3 + ((this.xs / this.maxSpeed) * this.w) / 6,
          this.pos.y + this.h / 3.5,
          5,
          5
        )
        ellipse(
          this.pos.x +
            this.w -
            this.w / 3 +
            ((this.xs / this.maxSpeed) * this.w) / 6,
          this.pos.y + this.h / 3.5,
          5,
          5
        )
      ...
      Player.prototype.shoot = function () {
        ...
        if (this.fired === false) {
          ...
          for (var i = game.enemies.length - 1; i >= 0; i--) {
            ...
            if (
              this.bullet.pos.x + this.bullet.w > enemy.pos.x &&
...

    {
      ...
      Game.prototype.resetSpiders = function () {
        ...
        for (var i = 0; i < 3; i++) {
          this.kamikazeSpiders.push(
            new KamikazeSpider(
              new PVector(random(30, width - 30), random(50, 100))
            )
          )
        }
      }
      ...
      Game.prototype.resetGhosts = function () {
        this.kamikazeGhosts = []
        for (var i = 0; i < 3; i++) {
          this.kamikazeGhosts.push(
            new KamikazeGhost(
              new PVector(random(30, width - 30), random(50, 150))
            )
          )
        }
      }
      ...
      Game.prototype.images = {
        ...
        scene3: function () {
          ...
          var spiderWeb = new SpiderWeb({
            ...
            scale: new PVector(0.75, 0.75),
          })
          spiderWeb.display()
          var spiderWeb2 = new SpiderWeb({
      ...
      Game.prototype.checkCollisionEnemy = function (player) {
        ...
        for (var i = 0; i < this.enemies.length; i++) {
          ...
          if (
            player.pos.x + player.w > enemy.pos.x &&
      ...
      Game.prototype.checkCollisionAmmo = function (player) {
        ...
        for (var i = this.ammunition.length - 1; i >= 0; i--) {
          ...
          if (
            player.pos.x + player.w > ammo.pos.x &&
      ...
      Game.prototype.checkCollisionCoin = function (player, coin) {
        ...
        if (
          player.pos.x + player.w > coin.pos.x &&
      ...
      Game.prototype.updateKamikazeZombie = function () {
        //level 2 - zombies
        this.ledgeX += 0.5 * this.ledgeDir
        if (this.kamikazeZombie.timeToFall > 0) {
          this.kamikazeZombie.pos.x +=
            0.5 * this.kamikazeZombie.speed * this.kamikazeZombie.dir

          if (
            this.kamikazeZombie.pos.x <= this.ledgeX ||
            this.kamikazeZombie.pos.x + this.kamikazeZombie.w >=
              this.ledgeX + 100
          ) {
        ...
        if (this.kamikazeZombie.isOnGround) {
          ...
          this.kamikazeZombie = new KamikazeZombie(
            new PVector(this.ledgeX + 30, 60)
          )
        }
      ...
      Game.prototype.updateKamikazeSpiders = function () {
        //level 3 - spiders
        for (var i = this.kamikazeSpiders.length - 1; i >= 0; i--) {
          ...
          if (kamizazeSpider.timeToFall > 0) {
            ...
            line(
              kamizazeSpider.pos.x + kamizazeSpider.w / 2,
              0,
              kamizazeSpider.pos.x + kamizazeSpider.w / 2,
              kamizazeSpider.pos.y
            )
            kamizazeSpider.pos.y +=
              0.5 * kamizazeSpider.speed * kamizazeSpider.yDir

            if (
              kamizazeSpider.pos.y < 50 ||
              kamizazeSpider.pos.y + kamizazeSpider.h > 200
            ) {
      ...
      Game.prototype.updateKamikazeGhosts = function () {
        //level 4 - ghosts
        for (var i = this.kamikazeGhosts.length - 1; i >= 0; i--) {
          ...
          if (kamizazeGhost.timeToFall > 0) {
            ...
            kamizazeGhost.dy =
              sin(radians(kamizazeGhost.theta)) * kamizazeGhost.amplitude

            kamizazeGhost.pos.x += kamizazeGhost.speed * kamizazeGhost.dir
            kamizazeGhost.pos.y = kamizazeGhost.ybase + kamizazeGhost.dy

            if (
              kamizazeGhost.pos.x < 50 ||
              kamizazeGhost.pos.x + kamizazeGhost.w > width - 50
            ) {
              kamizazeGhost.dir *= -1
            }
          }
          ...
          if (kamizazeGhost.isOnGround) {
            this.enemies.push(
              new KamikazeGhost(
                new PVector(kamizazeGhost.pos.x, kamizazeGhost.pos.y)
              )
            )
      ...
      Game.prototype.updateKamikazeVampires = function () {
        //level 5 - vampires
        for (var i = this.kamikazeVampires.length - 1; i >= 0; i--) {
          ...
          if (kamizazeVampire.timeToFall > 0) {
            ...
            kamizazeVampire.dy =
              sin(radians(kamizazeVampire.theta)) * kamizazeVampire.amplitude
            ...
            if (
              kamizazeVampire.flyUp > 0 &&
              kamizazeVampire.pos.y > kamizazeVampire.flyUp
            ) {
              kamizazeVampire.ybase -= 2
            }

            if (
              kamizazeVampire.pos.x < 50 ||
              kamizazeVampire.pos.x + kamizazeVampire.w > width - 50
            ) {
      ...
      Game.prototype.updateVampires = function () {
        //level 5 - vampires
      ...
      Game.prototype.stats = function () {
        ...
        text(
          'Enemies: ' +
            (this.levels[this.level].enemiesToKill - this.enemiesKilled),
          280,
          10
        )
      ...
      Game.prototype.gameover = function () {
        ...
        text(
          'Enemies Killed: ' +
            this.enemiesKilled +
            '/' +
            this.levels[this.level].enemiesToKill,
          300,
          215
        )
        this.homeButton.draw()
